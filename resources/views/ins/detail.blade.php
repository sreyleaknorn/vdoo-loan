...
<div class="card card-gray">
	<div class="toolbox">
        ...
        <a href="{{url('in/print/' . $in->id)}}" target="_blank"
            class="btn btn-primary btn-oval btn-sm">
            <i class="fa fa-print"></i> Print
        </a>
        <a href="{{url('in/delete/'.$in->id)}}" class="btn btn-danger btn-sm btn-oval" 
            onclick="return confirm('You want to delete?')">
            <i class="fa fa-trash"></i> Delete
        </a>
        <a href="{{url('in')}}" class="btn btn-warning btn-oval btn-sm">
	...
	<div class="card-block">
        ...
        <form >
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group row">
                        <label class="col-sm-4 form-control-label">Date In</label>
                        <div class="col-sm-8">
                            <span id="lb_in_date">{{$in->in_date}}</span>
                            <input type="date" class="form-control hide" value="{{$in->in_date}}" id="in_date">
                        </div>
                    </div>
                ...
                <div class="col-sm-6">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <input type="text" class="form-control hide" id="reference" value="{{$in->reference}}">
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group row">
                        <label class="col-sm-4">In By</label>
                        <div class="col-sm-8">
      ...
      <form action="#">
          <div class="modal-content">
              ...
              <div class="modal-body">
                    <input type="hidden" value="{{$in->id}}" id="id">
                    <input type="hidden" value="{{$in->in_date}}" id="in_date">
                  <div class="form-group row">
        ...
        if(con)
        {
            $.ajax({
                ...
                success: function (sms) {
                    ...
                    if(sms>0)
                    {
                        location.href = burl + "/in/detail/" + sms;
                    }
                    else{
