...
Route::get('loan/print_loan', 'LoanController@print_loan');
Route::get('print_loan/search', 'LoanController@search_print_loan');
Route::get('print_loan/print', 'LoanController@_print_loan');